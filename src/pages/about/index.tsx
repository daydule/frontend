    ...
    <div className='mx-auto px-12 pb-36'>
      <section className='my-16'>
        <div className='flex items-center justify-center'>
          ...
          <div className='my-48 font-mono text-9xl font-bold'>daydule</div>
        </div>
        ...
        <p className='mb-12 mt-36 text-center text-6xl'>活用の流れのイメージ</p>
        <div className='my-24 grid grid-cols-2 gap-12'>
          <div className='flex flex-col items-end justify-center'>
            <div className='text-5xl font-semibold'>1. 予定を登録</div>
            <div className='text-3xl'>時刻を指定して予定を登録</div>
          </div>
          <div>
            <img src='aboutPageContents/registerPlan.gif' alt='予定を登録のgif' className='rounded shadow-lg' />
          </div>
          <div>
            <img src='aboutPageContents/registerTodo.gif' alt='TODOを登録のgif' className='rounded shadow-lg' />
          </div>
          <div className='flex flex-col items-start justify-center'>
            <div className='text-5xl font-semibold'>2. TODOを登録</div>
            <div className='text-3xl'>所要時間を指定してTODOを登録</div>
          </div>
          <div className='flex flex-col items-end justify-center'>
            <div className='text-5xl font-semibold'>3. TODOの優先度を調整</div>
            <div className='text-3xl'>優先したいTODOを上へ</div>
          </div>
          <img
          ...
          />
          <div>
            <img src='aboutPageContents/createSchedule.gif' alt='TODOを予定に変換のgif' className='rounded shadow-lg' />
          </div>
          <div className='flex flex-col items-start justify-center'>
            <div className='text-5xl font-semibold'>4. TODOを予定に変換</div>
            <div className='text-3xl'>ボタン一つでTODOを予定に変換！！！</div>
          </div>
        </div>
      </section>
      {isError && (
      ...
      <section className='mx-auto w-3/5'>
        <div className='mb-4 mt-12 text-3xl font-bold'>dayduleへのフィードバック</div>
        <div className='mb-6 text-xl'>ログイン後右上の「フィードバック」ボタンから皆様のご意見をお聞かせください。</div>
        <img src='aboutPageContents/sendFeedback.gif' alt='TODOを予定に変換のgif' className='rounded shadow-sm' />
        <div className='mb-4 mt-12 text-3xl font-bold'>今後のアップデート予定</div>
        <ul className='list-disc pl-5'>
          <li className='text-xl'>既存機能のブラッシュアップ</li>
          <li className='text-xl'>ユーザー情報のアップデート機能</li>
          <li className='text-xl'>（ログインユーザー限定）繰り返しの予定機能</li>
        </ul>
        <div className='my-6 text-2xl'>フィードバックをもとに、さらにパワーアップ予定！</div>
        <div className='mb-4 mt-12 text-3xl font-bold text-red-700'>注意</div>
        <ul className='list-disc pl-5'>
